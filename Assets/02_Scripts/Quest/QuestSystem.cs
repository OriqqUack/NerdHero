...
public class QuestSystem : MonoBehaviour
{
    ...
    public delegate void WaitingForQuestCompletedHandler(Quest quest);
    public delegate void QuestCanceledHandler(Quest quest);
    #endregion

    private static QuestSystem instance;
    private static bool isApplicationQuitting;
    private Dictionary<Quest, Transform> questOwner = new Dictionary<Quest, Transform>();
    ...
    private void Awake()
    {
        questDatatabase = Resources.Load<QuestDatabase>("Database/QuestDatabase");
        achievementDatabase = Resources.Load<QuestDatabase>("Database/AchievementDatabase");
    ...
    public Quest Register(Quest quest, Transform questOwner = null)
    {
        ...
        if(questOwner != null)
            this.questOwner.Add(newQuest, questOwner);
        
        return newQuest;
    }

    public Transform GetQuestOwner(Quest quest)
    {
        questOwner.TryGetValue(quest, out Transform owner);
        return owner;
    }
