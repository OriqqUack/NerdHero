...
{
    public static readonly Color CommonBG = new Color(0.308889f, 0.32156f, 0.305882f);         // 파란색 계열
    public static readonly Color CommonGradient = new Color(0.4039216f, 0.41960f, 0.4060691f);      // 주황색 계열
    public static readonly Color RareBG = new Color(0.380392f, 0.3137255f, 0.588235f);     // 어두운 배경색
    public static readonly Color RareGradient = new Color(0.5529412f, 0.4392157f, 0.7803922f);         // 보라 계열 포인트 색
    public static readonly Color LegendaryBG = new Color(0.6941177f, 0.454902f, 0.2705882f);
