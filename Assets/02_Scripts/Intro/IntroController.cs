...
{
    public Image blackScreen;     // 검정 → 흰 배경 전환용
    public GameObject logo;       // 로고 오브젝트
    public SkeletonGraphic graphic;
    public GoogleBackendAutoLoginManager loginUI;    // 로그인 UI
    [SerializeField] private AudioClip bgMusic;

    
    public float logoAppearDuration = 1.2f;
    public float whiteFadeDuration = 1.0f;
    public float logoMoveDuration = 1.0f;
